        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xl:col-span-2">
          ...
          <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100 min-h-[300px]">
            <div className="flex justify-between mb-4">
              <h4 className="font-montserrat text-lg font-bold text-[#3B82F6] flex items-center gap-2">
          ...
          <div className="hidden md:block bg-transparent min-h-[200px]"></div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 md:col-span-2">
             <div className="flex justify-between items-center mb-6">
              ...
              <button className="text-sm text-[#3B82F6] font-medium font-poppins hover:underline">See all</button>
            </div>
          </div>
