  ...
  return (
    <main className="flex items-center justify-center min-h-[calc(100vh-64px)] px-4 py-12 bg-gray-50">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-2xl">
        ...
        <h2 className="font-montserrat font-bold text-3xl text-red-500 text-center mb-6">
        ...
        <p className="font-poppins text-lg text-center mb-10">
          ...
          <button
            onClick={() => navigate(`/reschedule/${id}`, { state: { department, doctor, date } })}
            className="text-gabay-teal font-semibold underline hover:no-underline inline"
          >
            here
          </button>{' '}
          to reschedule your appointment reservation for another date instead. Otherwise, click the link below.
        </p>
