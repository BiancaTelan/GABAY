    ...
    <main className="flex flex-col items-center justify-start min-h-[calc(100vh-64px)] px-4 py-12 bg-gray-50">
      <div className="w-full max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row gap-6 mt-12">
          ...
          <div
            className="flex-1 rounded-xl shadow-md overflow-hidden relative min-h-[300px]"
          ...
          >
            ...
            <div className="relative z-10 p-8 flex flex-col h-full text-white">
              ...
              <button 
                onClick={() => navigate('/general-form')}
                className="font-poppins text-white font-semibold text-lg hover:underline group text-left mt-auto">
          ...
          >
            ...
            <div className="relative z-10 p-8 flex flex-col h-full text-white">
              ...
              <p className="font-poppins text-gray-100 text-sm leading-relaxed">
                Provides consultations for specific
                <br />
                medical fields and chronic conditions
              </p>
              <div className="mt-4 mb-10">
                <p className="font-poppins text-white text-sm">
              ...
              <button 
                onClick={() => navigate('/specialty-form')}
                className="font-poppins text-white font-semibold text-lg hover:underline group text-left mt-auto">
